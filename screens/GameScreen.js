...
const GameScreen = (props) => {
  ...
  const [availableDeviceHight, setAvailableDeviceHight] = useState(
  ...
  useEffect(() => {
    const updateLayout = () => {
      ...
      setAvailableDeviceHight(Dimensions.get("window").height);
    };
  ...
  const nextGuessHandler = (direction) => {
    if (
      ...
      Alert.alert("Don't lie!", "You know that this is wrong you scum....", [
